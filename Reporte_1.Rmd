---
title: "Reporte Incendios Forestales Semana 1"
...
Observamos la base de datos, y por el momento tengo un cocentrado que se actualiza semanalmente hasta la semana 11, entonces filtraré los datos a la semana 1
...
###  Estados con mayor incidencia de incendios 
...
table(semana_1$`Tipo de atención`)
...
El tipo de vegetación afecta a areas afectadas? i.e por la vegetación se puede quemar mas area?
...
No existe ninguna correlación,ninguna afectación etc etc etc. De la semana 1 el Tipo de Vegetación con más incendios fue el Bosque Pino, sin embargo en que más hectarea afectada abarcó fue uno de tipo Selva Baja Caudicifolia. Como se observa en la gráfica
